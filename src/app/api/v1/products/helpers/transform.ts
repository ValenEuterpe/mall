...
type ProductDetail = Prisma.ProductGetPayload<{
  select: typeof import("./selects").PRODUCT_DETAIL_SELECT;
}>;

export function transformProductForList(
  product: Prisma.ProductGetPayload<{
    select: typeof import("./selects").PRODUCT_LIST_SELECT;
  }>,
    ...
    shop: {
      ...
      seller: product.shop.seller
        ? {
            ...
            socialLinks: product.shop.seller.socialLinks as Record<
              string,
              unknown
            > | null,
