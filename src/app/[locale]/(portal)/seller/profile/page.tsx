...
import { ArrowLeft, Building2, Mail, MapPin, Pencil, Phone, Save, Store, User } from "lucide-react";
          ...
          <CardContent>
            {profile?.shops && profile.shops.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="font-semibold">{formatShopLocation(shop.code, tCommon)}</span>
                        {shop.name && (
                      ...
                      <div className="flex items-center gap-1 text-sm text-muted-foreground mt-1">
                        ...
                        <span>
                          {[shop.venue, shop.building, shop.floor !== null && t("floorLabel", { floor: shop.floor })]
                            .filter(Boolean)
                            .join(" • ")}
                        </span>
                      </div>
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-sm mt-1">{t("contactMallOwner")}</p>
              </div>
            )}
          </CardContent>
        </Card>
