  ...
  (
    ...
    const loginSchema = useMemo(
      () =>
        createLoginSchema((key) => {
          if (key === "emailRequired" || key === "passwordRequired")
    ...
    return (
      <Card className={cn("w-full", className)}>
        ...
        <form
          onSubmit={handleSubmit((d) => void handleFormSubmit(d))}
          noValidate
        ...
        >
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <p className="text-muted-foreground text-center text-sm">
              ...
              <Link
                href="/signup"
                className="text-primary focus:ring-primary font-medium hover:underline focus:ring-2 focus:ring-offset-2 focus:outline-none"
                tabIndex={isSubmitting ? -1 : 0}
              >
                {t("signup")}
              </Link>
