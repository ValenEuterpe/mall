...
export async function clearAuthCookies(): Promise<void> {
  ...
  cookieStore.set(cookieConfig.names.accessToken, "", cookieConfig.clear);
  cookieStore.set(cookieConfig.names.refreshToken, "", cookieConfig.clear);
}
...
export async function terminateAllUserSessions(
  ...
  try {
    ...
    logger.error("Failed to terminate all sessions for user", {
      userId,
      error,
    });
    throw error;
